// alchemist-Assistant — 全阶段整合 AI 助手
//
// 目录结构：
//
...
import (
	...
	"alchemist-Assistant/internal/agent"
	"alchemist-Assistant/internal/handler"
	"alchemist-Assistant/internal/platform/es"
	"alchemist-Assistant/internal/platform/kafka"
	"alchemist-Assistant/internal/platform/milvus"
	"alchemist-Assistant/internal/platform/postgres"
	"alchemist-Assistant/internal/repo/chathistory"
	"alchemist-Assistant/internal/repo/eventbus"
	"alchemist-Assistant/internal/repo/longterm"
	"alchemist-Assistant/internal/repo/preference"
	"alchemist-Assistant/internal/repo/ragchunk"
	"alchemist-Assistant/internal/repo/snapshot"
	"fmt"
	"log"
	"net/http"
)
